...
public class DoiMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnDMK.setBackground(new java.awt.Color(255, 204, 0));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnDMK, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        trangChu.setVisible(true);
    ...
    private void doiMatKhau() {
        ...
        if (maNV.isEmpty() && matKhauCu.isEmpty() && matKhauMoi.isEmpty() && xacNhanMatKhauMoi.isEmpty()) {
            HienThiND.alert(this, "Vui lòng nhập thông tin.");
            return;
        }
        if (maNV.isEmpty()) {
            HienThiND.alert(this, "Vui lòng nhập tên đăng nhập");
            return;
        }
        if (matKhauCu.isEmpty()) {
            HienThiND.alert(this, "Vui lòng nhập mật khẩu cũ");
            return;
        }
        if (matKhauMoi.isEmpty()) {
            HienThiND.alert(this, "Vui lòng nhập mật khẩu mới");
            return;
        }

        if (matKhauMoi.isEmpty() || xacNhanMatKhauMoi.isEmpty()) {
            HienThiND.alert(this, "Vui lòng nhập lại mật khẩu mới");
            return;
        }

        if (!matKhauMoi.equals(xacNhanMatKhauMoi)) {
            HienThiND.alert(this, "Mật khẩu xác nhận không đúng!");
            return;
        }

        NhanVien nv = dao.selectByEmail(maNV);
        if (nv == null) {
            HienThiND.alert(this, "Tên đăng nhập không tồn tại!");
            return;
        }

        if (!nv.getMatKhau().equals(matKhauCu)) {
            HienThiND.alert(this, "Sai mật khẩu cũ!");
            clearForm();
            return;
        }
        ...
        HienThiND.alert(this, "Đổi mật khẩu thành công!");
        dispose();
    }
