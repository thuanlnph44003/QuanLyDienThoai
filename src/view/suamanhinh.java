 ...
 * @author ACER
 */
public class suamanhinh extends javax.swing.JInternalFrame {
 List<manhinhmolde> list = new ArrayList<>();
    DefaultTableModel model;
    svmanhinh mh=new svmanhinh();
    /**
     * Creates new form suamanhinh
     */
    public suamanhinh() {
        initComponents();
    ...
    void fillmanhinh() {
        ...
        for (manhinhmolde mhh : list) {
            model.addRow(new Object[]{mhh.getIdMH(), mhh.getManHinh()});
        }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        int id = list.get(row).getIdMH(); // Giả sử mã sản phẩm là kiểu int
   ...
   manhinhmolde getFromdata() {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        manhinhmolde tensp = getFromdata();
        int id = list.get(row).getIdMH();
        tensp.setIdMH(id);
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        manhinhmolde tsp = list.get(row);
        txtidmanhinh.setText(String.valueOf(tsp.getIdMH()));
        txtmanhinh.setText(tsp.getManHinh());
    }//GEN-LAST:event_tableMouseClicked

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here
        try {
            manhinhmolde manhh = getFromdata();
